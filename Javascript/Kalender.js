...
function resterendeTid(slutt) { 
    let totalTid = Date.parse(slutt) - Date.now(); /*beregner millisekunder fra nå til slutt*/
    let timer = Math.floor(totalTid/(1000*60*60)); /*gjør om millisekunder til timer*/
    let dager = Math.floor(totalTid/(1000*60*60*24));  /*gjør om anntall millisekunder til dager*/
    return {
        'Total': totalTid,
        'Timer': timer,
        'Dager': dager
...
const kommendeArrangement = [["Nov 6 2016", "Dec 10 2016"], ["Dec 11 2016", "Jan 7 2017"], ["Jan 8 2017", "Feb 4 2017"], ["Feb 5 2017", "Mar 3 2017"], ["Mar 4 2017", "Apr 29 2017"]];
